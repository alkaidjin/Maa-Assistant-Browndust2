...
| 文档 | 看它解决什么 |
|---|---|
| [#请务必打开此文档查阅#含使用方式以及常见问题解答.docx](%23请务必打开此文档查阅%23含使用方式以及常见问题解答.docx) | **使用前必看**：使用方式 + 常见问题 Q1–Q12（分辨率、前置程序、任务勾选…） |
...
2. 游戏内语言设为**简体中文**，以**窗口化 16:9** 运行（推荐 1920×1080）。分辨率不符时软件会弹窗告警并强制停止任务。
